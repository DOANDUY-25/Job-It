...
import vn.duy.jobIT.domain.dto.LoginDTO;
import vn.duy.jobIT.domain.res.auth.LoginResponse;
...
import vn.duy.jobIT.service.SecurityService;
...
public class AuthController {
    ...
    @Value("${duy.jwt.refresh-token-validity-in-seconds}")
